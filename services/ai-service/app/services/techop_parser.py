...
- manufacturer: производитель / изготовитель (если указан, иначе null)
- brand: марка / бренд / торговая марка / товарный знак (если указан, иначе null)
- model: модель / серия (если указана, иначе null)
- article_number: артикул / номер по каталогу / part number (если указан, иначе null)
- serial_numbers: серийные номера через запятую (если указаны, иначе null)
