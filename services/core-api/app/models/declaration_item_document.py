...
class DeclarationItemDocument(Base):
    ...
    record_id: Mapped[Optional[str]] = mapped_column(String(36))
    electronic_doc_id: Mapped[Optional[str]] = mapped_column(String(36))
    electronic_arch_id: Mapped[Optional[str]] = mapped_column(String(36))
    document_mode_id: Mapped[Optional[str]] = mapped_column(String(10))
    doc_begin_date: Mapped[Optional[date]] = mapped_column(Date)
    presenting_customs_code: Mapped[Optional[str]] = mapped_column(String(8))
    presenting_reg_date: Mapped[Optional[date]] = mapped_column(Date)
    presenting_gtd_number: Mapped[Optional[str]] = mapped_column(String(7))
